...
{ 
    WORD bfType; 
    DWORD bfSize; 
    //total size of file in bytes - including pixels, padding and headers
...
typedef struct
{
    ...
    //width is changing
    LONG biHeight; 
    //heigh of image in pixels is changing
    WORD biPlanes; 
    WORD biBitCount; 
    DWORD biCompression; 
    DWORD biSizeImage; 
    //total size of image in bytes - inc pixels and padding - is changing
